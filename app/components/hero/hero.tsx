...
const Hero = () => {
  return(
    <div className='relative w-full flex flex-col items-center gap-4'>
      ...
      <div className="flex  gap-2 justify-center ">en <span className="text-primary">avis 5 </span><StarIcon  width={42} height={42} /></div>
    </Typography>
    ...
    <Button>Commencer maintenant</Button>
      <Typography variant="p" className="mt-8 flex gap-2 items-center">
        <StarIcon className="text-background bg-primary p-1 rounded-full" width={24} height={24} />
