...
const Footer = () => {
  ...
  return (
    ...
    <footer className="relative z-20 bg-card w-full py-10 border-t  mt-20 ">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <section className="flex  flex-wrap sm:flex-row justify-between gap-10 sm:gap-5 pt-10 ">
          <div >
            ...
            <Link href="mailto:contact@fiveup.com" className="text-sm hover:underline text-white" >contact@fiveup.com</Link>
          </div>
